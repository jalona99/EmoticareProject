...
<body>
    <div class="container">
        ...
        <!-- Filters -->
        <div class="filters">
            <form method="get" action="${pageContext.request.contextPath}/admin/assessments" style="display: flex; gap: 12px; align-items: center;">
                ...
                <select name="typeId" class="filter-select">
                    ...
                    <c:forEach var="type" items="${assessmentTypes}">
                        <option value="${type.id}" ${selectedTypeId eq type.id ? 'selected' : ''}>${type.name}</option>
                    </c:forEach>
                </select>
                        ...
                        <tbody>
                            <c:forEach var="assessment" items="${assessments}">
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="${pageContext.request.contextPath}/admin/assessments/${assessment.id}" class="action-btn">👁️ View</a>
                                        </div>
                                    </td>
                                </tr>
                            </c:forEach>
