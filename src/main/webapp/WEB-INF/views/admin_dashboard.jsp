                ...
                <div class="container">
                    ...
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/assessments">Assessments</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/forum">Peer Forum</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/reports">Reporting & Stats</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/badges">Badge Management</a>
                            </li>
                        </ul>
                    ...
                    <div class="main-content">
                        ...
                        <div class="dashboard-grid">
                            ...
                            <div class="card">
                                ...
                                <div class="card-value">${riskStats != null && riskStats['HIGH'] != null ?
                                    riskStats['HIGH'] : 0}</div>
                                <div class="card-footer">
                                    <a href="/emoticare/admin/assessments?status=COMPLETED" class="card-link">Review
                                        cases →</a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <a href="/emoticare/admin/assessments?status=COMPLETED" class="card-link">See
                                        details →</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="entry" items="${riskStats}">
                                                ...
                                                <c:choose>
                                                    <c:when test=" ${entry.key=='HIGH' }">risk-high
                                </c:when>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <fmt:formatDate value="${systemDate}" pattern="dd/MM/yyyy HH:mm:ss" />
                                        </td>
                                    </tr>
                                    <tr>
