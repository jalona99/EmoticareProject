...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="${pageContext.request.contextPath}/learning/hub">Learning Hub</a>
            ...
            <a href="${pageContext.request.contextPath}/peer/forum">Peer Forum</a>
        </nav>
    ...
    <div class="container">
        ...
        <div class="features-grid">
            ...
            <a href="${pageContext.request.contextPath}/assessment/select" class="feature-card">
                ...
                <p>Take validated mental health assessments including PHQ-9, GAD-7, and stress screening tests.</p>
            ...
            <!-- 2. Learning Hub Card -->
            <a href="${pageContext.request.contextPath}/learning/hub" class="feature-card">
                <div class="feature-icon">📚</div>
                <h3>Learning Hub</h3>
            ...
            <!-- 5. Peer Forum Card -->
            <a href="${pageContext.request.contextPath}/peer/forum" class="feature-card">
                <div class="feature-icon">👥</div>
                <h3>Peer Forum</h3>
